...
class TestSecurityGroupOperations:
    ...
    def test_get_security_groups_success(
        self, sg_ops: SecurityGroupOperations, mock_aws_client: AWSClient
    ) -> None:
    ...
    def test_get_security_groups_empty(
        self, sg_ops: SecurityGroupOperations, mock_aws_client: AWSClient
    ) -> None:
    ...
    def test_get_security_groups_with_rules(
        self, sg_ops: SecurityGroupOperations, mock_aws_client: AWSClient
    ) -> None:
                    ...
                    "IpPermissions": [
                        {
                            ...
                            "ToPort": 443,
                            "IpRanges": [
                                {"CidrIp": "10.0.0.0/16", "Description": "Internal"}
                            ],
                        },
                        {
                            "IpProtocol": "tcp",
