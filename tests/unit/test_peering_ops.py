...
class TestVPCPeeringOperations:
    ...
    def test_get_vpc_peering_connections_success(
        self, peering_ops: VPCPeeringOperations, mock_aws_client: AWSClient
    ) -> None:
    ...
    def test_get_vpc_peering_connections_pending(
        self, peering_ops: VPCPeeringOperations, mock_aws_client: AWSClient
    ) -> None:
