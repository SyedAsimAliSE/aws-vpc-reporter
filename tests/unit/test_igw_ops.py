...
class TestInternetGatewayOperations:
    ...
    def test_get_internet_gateways_success(self, igw_ops: InternetGatewayOperations, mock_aws_client: AWSClient) -> None:
    ...
    def test_get_internet_gateways_empty(self, igw_ops: InternetGatewayOperations, mock_aws_client: AWSClient) -> None:
        """Test VPC with no internet gateways."""
        mock_aws_client.describe_internet_gateways.return_value = {"InternetGateways": []}
    ...
    def test_get_internet_gateways_detached(self, igw_ops: InternetGatewayOperations, mock_aws_client: AWSClient) -> None:
