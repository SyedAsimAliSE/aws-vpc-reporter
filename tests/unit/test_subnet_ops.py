...
class TestSubnetOperations:
    ...
    def test_get_subnets_success(
        self, subnet_ops: SubnetOperations, mock_aws_client: AWSClient
    ) -> None:
    ...
    def test_get_subnets_ipv6(
        ...
        assert (
            result["subnets"][0]["ipv6_cidr_blocks"][0]["ipv6_cidr_block"]
            == "2600:1f13:fe8:5a00::/64"
        )
        assert result["subnets"][0]["ipv6_cidr_blocks"][0]["state"] == "associated"

    def test_get_subnets_outpost(
        self, subnet_ops: SubnetOperations, mock_aws_client: AWSClient
    ) -> None:
