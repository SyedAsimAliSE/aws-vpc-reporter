        ...
        for vpn in vpn_connections:
            ...
            for tunnel in options.get("TunnelOptions", []):
                tunnel_options.append({
                    ...
                    "rekey_margin_time_seconds": tunnel.get("RekeyMarginTimeSeconds"),
            ...
            processed_vpns.append({
                ...
                "transport_transit_gateway_attachment_id": options.get("TransportTransitGatewayAttachmentId"),
                "tunnel_inside_ip_version": options.get("TunnelInsideIpVersion", "ipv4"),
                # Tunnel details
                ...
                "all_tunnels_up": tunnel_status_summary.get("up", 0) == len(telemetry) and len(telemetry) > 0,
                # Metadata
                "tags": vpn.get("Tags", []),
