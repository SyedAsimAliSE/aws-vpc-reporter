            ...
            processed_subnets.append(
                {
                    ...
                    # IPv6 configuration
                    "assign_ipv6_on_creation": subnet.get(
                    ...
                    "private_dns_hostname_type": dns_options.get(
                        "HostnameType", "ip-name"
                    ),
                    "enable_resource_name_dns_a_record": dns_options.get(
                        "EnableResourceNameDnsARecord", False
                    ),
                    "enable_resource_name_dns_aaaa_record": dns_options.get(
                        "EnableResourceNameDnsAAAARecord", False
                    ),
                    # Customer-owned IP
                    "map_customer_owned_ip": subnet.get(
